...
const APPS: AppEntry[] = [
  ...
  { id: 'map',          name: 'City Map',       publisher: 'GridOS Corp',          tier: 'CORPORATE',   desc: 'Navigate the city grid. Move between districts, scan for nearby signals, probe open networks, and locate hack targets in the physical world.',    price: 0, unlockId: 'map' },
